...
namespace EmployeeFeature.GraphQL
{
    ...
    public class EmployeeMutation
    {
        ...
        public async Task<BaseResponse<CreateEmployeeResponse>>
        CreateEmployeeAsync(
        ...
        public async Task<BaseResponse<UpdateEmployeeResponse>>
            UpdateEmployeeAsync(
        ...
        public async Task<BaseResponse<DeleteEmployeeResponse>>
            DeleteEmployeeAsync(
