...
namespace AttendanceFeature.GraphQL
{
    ...
    public class AttendanceMutation
    {
        ...
        public async Task<BaseResponse<CreateAttendanceResponse>>
        ...
        public async Task<BaseResponse<UpdateAttendanceResponse>>
        ...
        public async Task<BaseResponse<DeleteAttendanceResponse>>
